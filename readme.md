Simulation of particle agents following each others trails using compute shaders. This resembles the [physarum transport networks](https://uwe-repository.worktribe.com/output/980579)
